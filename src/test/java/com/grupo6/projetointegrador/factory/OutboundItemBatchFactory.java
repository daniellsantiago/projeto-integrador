...
public class OutboundItemBatchFactory {
  ...
  public static OutboundItemBatch build(OutboundOrder outboundOrder, InboundOrder inboundOrder) {
    OutboundItemBatch itemBatch = new OutboundItemBatch();
    ...
    itemBatch.setOutboundOrder(outboundOrder);
