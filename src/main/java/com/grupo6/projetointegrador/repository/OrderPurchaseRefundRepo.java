...
public interface OrderPurchaseRefundRepo extends JpaRepository<OrderPurchaseRefund, Long> {
    @Query(
            "SELECT new com.grupo6.projetointegrador.dto.OrderPurchaseRefundDto(" +
                    "opr.id, " +
    ...
    List<OrderPurchaseRefundDto> findAllFiltered(Long buyerId, RefundReason refundReason, Long sellerId);
}
